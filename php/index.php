...
$adres = "wuuwuu@poczta.onet.pl";
mysqli_query($link,"INSERT INTO newsletter SET imie='Wojciech', nazwisko='Wiński', email='".$adres."'");
...
$mail->Body = "Treść wiadomości<br>".file_get_contents('contents.html')."<a href='http://tlustalangusta.pl/demo/usun.php?adresEmail=".$adres."'>wypisz się</a>";    //Treść wiadomości, można stosować zmienne i znaczniki HTML
...
$mail->SMTPAutoTLS = true;   //wyłączenie TLS
$mail->SMTPSecure = '';    //
